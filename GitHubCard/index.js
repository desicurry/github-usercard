...
axios.get('https://api.github.com/users/desicurry')
.then(response=>{
...
const followersArray = ['alisonludick', 'sundakat', 'wolfaholic', 'ballewaer', 'divbySeptember', 'javontaymcelroy', 'notdb', 'gebhartn'];
